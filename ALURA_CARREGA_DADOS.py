...
# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS LOADERZ.DATA_LAKE_EMPRESAS;
# MAGIC DROP TABLE IF EXISTS LOADERZ.DATA_LAKE_SOCIOS;
# MAGIC DROP TABLE IF EXISTS LOADERZ.DATA_LAKE_ESTABELECIOMENTOS;
